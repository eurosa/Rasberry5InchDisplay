...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/pi/icon/play_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/pi/icon/speaker-on-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.label_10.setPixmap(QtGui.QPixmap("/home/pi/icon/heater_white_60_60.png"))
        ...
        self.label_9.setPixmap(QtGui.QPixmap("/home/pi/icon/thermometer_60_60.png"))
...
"}")
        ...
        self.label_8.setPixmap(QtGui.QPixmap("/home/pi/icon/thermometer_60_60.png"))
...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("/home/pi/icon/SST.png"))
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/pi/icon/settings_white_color.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
